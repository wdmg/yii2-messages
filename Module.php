...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        ...
        if (Yii::$app instanceof \yii\console\Application)
            $this->controllerNamespace = 'wdmg\messages\commands';
    ...
    {
        Yii::$app->i18n->translations['app/modules/messages'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@vendor/wdmg/yii2-messages/messages',
        ...
        $this->name = Yii::t('app/modules/messages', $this->name);
        $this->description = Yii::t('app/modules/messages', $this->description);
    }

    public static function t($category, $message, $params = [], $language = null)
    {
        return Yii::t('app/modules/messages' . $category, $message, $params, $language);
    }
    ...
    public function dashboardNavItems()
    {
        return [
            'label' => $this->name,
            'url' => [$this->routePrefix . '/messages/'],
            'active' => in_array(\Yii::$app->controller->module->id, ['messages'])
        ];
    }
}